...
const { uploadMusic, CreateAlbum, getMusic, getAlbumTitle, getAlbumById } = require("../controllers/music.controller")
...
router.get("/album", validUser, getAlbumTitle);
router.get("/album/:id", validUser, getAlbumById)
